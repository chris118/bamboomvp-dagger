package com.hhit.bamboolibrary.widget;
...
import com.hhit.bamboolibrary.R;

/**
 * Created by xiaopeng on 2017/8/1.
 */

public class RWLoadingDialog extends Dialog {
    ...
    public RWLoadingDialog(Context context) {
...
//        getWindow().setWindowAnimations(R.anim.alpha_in);
    ...
    public static void dismissDialog(RWLoadingDialog RWLoadingDialog) {
        if (null == RWLoadingDialog) {
            return;
        }
        RWLoadingDialog.dismiss();
    }
}
